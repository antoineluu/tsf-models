...
class ClassificationPipeline(BasePipeline):
    def __init__(self, problem: ClassificationProblem, model: Union[BaseModel, ModelFrameworkService] = None, **kwargs):
    ...
    def make_pipeline(self):
        self.transformer = PreprocessPipeline([TimeSeriesImputer(method=self.impute_method), PandasNumpyTransformer()])
